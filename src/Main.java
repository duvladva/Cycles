public class Main {
    ...
    public static void task8() {
        System.out.println("Задача 8. Посчитайте с помощью цикла for сумму годовых накоплений, если каждый месяц вы будете откладывать по 29 000 рублей «в банку». Выведите сумму накоплений за каждый месяц в консоль в формате: «Месяц …, сумма накоплений равна … рублей».");
        System.out.println("Решение: ");
        int salary = 29000;
        int total = 0;
        for (int i = 1; i <= 12; i++) {
